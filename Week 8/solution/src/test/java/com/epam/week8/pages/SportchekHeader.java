...
public class SportchekHeader extends BasePage {
	...
	private final String preferredStoreLocator = "(//span[@class='nl-store-locator--selected-store'])[2]";
	
	@Getter private WebElement preferredStoreInHeader;
	
	public SportchekHeader(WebDriver driver) {
		super(driver);
		preferredStoreInHeader = js.findElementByXPath(preferredStoreLocator);
	}
