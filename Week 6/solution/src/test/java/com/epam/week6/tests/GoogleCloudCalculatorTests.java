...
public class GoogleCloudCalculatorTests extends BaseTest {
	...
	public void cloudPlatformPricingCalculatorWithEmailTest() {
		...
		// Here the do-while loop is used, since we need to click the refresh button at least once to see if email has come,
		// and if it is not here yet - we need to continue clicking
		do {
