package com.epam.airport.tests;

import org.testng.Assert;
import org.testng.annotations.Test;
import com.epam.airport.Airport;
...
public class AirportTest {
	...
	public void testGetTransportMilitaryPlanes() {
		...
		Assert.assertTrue(listContainsTransportMilitaryPlanes);
	}
	...
	public void testGetPassengerPlaneWithMaxCapacity() {
		...
		Assert.assertTrue(expectedPlaneWithMaxPassengersCapacity
				.equals(planeWithMaxPassengerCapacity));
	}

	@Test
	public void testSortingOfPlanesByMaxLoadCapacity() {
		List<? extends Plane> planesSortedByMaxLoadCapacity = new Airport(planes)
				.sortByMaxLoadCapacity().getPlanes();
	...
	public void testHasAtLeastOneBomberInMilitaryPlanes() {
		...
		Assert.assertTrue(listHasAtLeastOneBomberMilitaryPlane);
	}
	...
	public void testExperimentalPlanesHaveClassificationLevelHigherThanUnclassified() {
		...
		boolean listHasUnclassifiedPlanes = false;
		
		for (ExperimentalPlane experimentalPlane : experimentalPlanes) {
			if (experimentalPlane.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED) {
				listHasUnclassifiedPlanes = true;
				break;
			}
		}
		
		Assert.assertFalse(listHasUnclassifiedPlanes);
	}
}
