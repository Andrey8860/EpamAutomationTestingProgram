...
public class SportchekStoreDetailsPage extends BasePage {
	...
	private WebElement storeTitleInDetailedAddressSection;
	...
	public WebElement getTitleOfPreferredStoreFromStoreDetailedAddress() {
		return storeTitleInDetailedAddressSection;
	}
