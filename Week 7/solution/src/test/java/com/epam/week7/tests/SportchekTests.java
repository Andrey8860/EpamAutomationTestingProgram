...
public class SportchekTests extends BaseTest {
	...
	public void sportchekPreferredStoreChangeFromStoreLocatorTest() {
		...
		System.out.println(storeDetailsPage.getTitleOfPreferredStoreFromStoreDetailedAddress().getText());
		System.out.println(sportchekHeader.getPreferredStoreInHeader().getText());
		Assert.assertTrue(storeDetailsPage.getTitleOfPreferredStoreFromStoreDetailedAddress().getText()
