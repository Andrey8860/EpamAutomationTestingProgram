...
import com.epam.week10.model.ComputeEngineGoogleCloudCalculatorEntity;
import com.epam.week10.model.Email;
import com.epam.week10.pages.ComputeEngineCloudCalculatorTab;
import com.epam.week10.pages.GoogleCloudHomePage;
import com.epam.week10.pages.GoogleCloudPricingCalculatorPage;
import com.epam.week10.pages.YopmailEmailInboxPage;
import com.epam.week10.pages.YopmailRandomEmailGeneratorPage;
import com.epam.week10.service.ComputeEngineGoogleCloudCreator;
import com.epam.week10.service.EmailCreator;
...
public class GoogleCloudCalculatorTests extends BaseTest {
	...
	public void cloudPlatformPricingCalculatorWithEmailTest() {
		...
		computeEngineCloudCalculatorTab
		...
		email = EmailCreator.createSpecificEmail(yopmailEmailInboxPage.getCurrentEmailAddressString());
